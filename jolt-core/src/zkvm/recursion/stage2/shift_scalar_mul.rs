...
use super::shift_rho::{eq_lsb_mle, eq_plus_one_lsb_mle};
...
impl<F: JoltField, T: Transcript> ShiftScalarMulProver<F, T> {
    pub fn new(
        ...
        let eq_step_8 = super::shift_rho::eq_lsb_evals::<F>(&step_ref);
        let eq_minus_one_8 = super::shift_rho::eq_plus_one_lsb_evals::<F>(&step_ref);
